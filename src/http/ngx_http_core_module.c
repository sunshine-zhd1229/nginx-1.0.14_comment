    ...
    ngx_http_phase_handler_t *ph)
{
    ...
    if (r->content_handler) {
    	//若设置了conent_handler，则直接调用，不再执行handlers执行链
...
ngx_http_core_server(ngx_conf_t *cf, ngx_command_t *cmd, void *dummy)
{
    ...
    http_ctx = cf->ctx;
    ctx->main_conf = http_ctx->main_conf;//main conf����
	...
	//�������е�servers�����Կ����Ǳ�����main�еġ�������������HTTP main�оͿ���ȡ������srv 
