...
ngx_http_block(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    *(ngx_http_conf_ctx_t **) conf = ctx;
    ...
    //�����Ǵ���http module�Ķ�Ӧ��main,srv,loc config
    /* the http main_conf context, it is the same in the all http contexts */
    
    //��ʼ��ʼ�������Կ���Ĭ�ϻ�����max��config 
    //����HTTP��Ӧ��conf����Ϊÿ������(main/ser/loc)��������ģ����conf
    ...
    for (m = 0; ngx_modules[m]; m++) {
        ...
        //�����ж�Ӧ�Ļص��������ûص�������Ȼ�󽫷��ص�ģ��config���õ�ctx�Ķ�Ӧ��conf�б���
    ...
    for (m = 0; ngx_modules[m]; m++) {
        ...
        //��������postconfiguratio�����ó�ʼ��,������ʼ��ģ��֮ǰ��Ҫ����preconfiguration������һЩ������
    ...
    //��http block��ȫparse����֮�󣬾���Ҫmerge(main��srv����srv��loc)���ص�config�ˡ�������ÿ��merge֮ǰ�������ȳ�ʼ��main conf��
    for (m = 0; ngx_modules[m]; m++) {
        if (ngx_modules[m]->type != NGX_HTTP_MODULE) {
            continue;
        }
    ...
    //��merge����֮����Ȼ�����ǳ�ʼ��location tree������handler phase������postconfiguration���Լ������ĳ�ʼ��
...
ngx_http_init_phase_handlers(ngx_conf_t *cf, ngx_http_core_main_conf_t *cmcf)
{
    ...
    //cmcf->phases数组中保存了在post config之前注册的所有模块函数
    
    //判断是否注册了REWRITE和ACCESS模块
    ...
    for (i = 0; i < NGX_HTTP_LOG_PHASE; i++) {
        h = cmcf->phases[i].handlers.elts;   	//每个阶段的第一个执行函数
    ...
    ngx_http_module_t *module, ngx_uint_t ctx_index)
{
    ...
    //�������е�server��Ȼ���ж�ģ���Ƿ���merge�ص������������еĻ����͵��ûص�����
    for (s = 0; s < cmcf->servers.nelts; s++) {
...
ngx_http_add_listening(ngx_conf_t *cf, ngx_http_conf_addr_t *addr)
{
    ...
    //����listen�����Ļص�,ע������handler������accept handler�����ǵ�accpet��֮�󣬴���accept���ľ����Ĳ���
